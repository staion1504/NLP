...
# # def text_summarizer(text, num_bigrams=10):
# #     cleaned_text = preprocess_text(text)
# #     bigrams = generate_ngrams(cleaned_text, n=2)
# #     bigram_freq = {}
...
# #     disambiguated_summary = ' '.join([disambiguate_word(word) for bigram, freq in selected_bigrams for word in bigram.split()])
...
#     bigrams = generate_bigrams(cleaned_text, n=2)
